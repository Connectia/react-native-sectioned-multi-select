...
class SectionedMultiSelect extends PureComponent {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      useInBottomSheet: props.useInBottomSheet
    }
  }
  ...
  _renderChips = () => {
    ...
    // work around to make touchables in bottom sheet 
    const TouchableForBottomSheet = useInBottomSheet && Platform.OS === "android" ? TouchableOpacityBottomSheet : Touchable;
      ...
      <View
        ...
        {selectedItems.length > 1 && showRemoveAll ? (
          <View
            ...
            <TouchableForBottomSheet
              onPress={() => {
                console.log('yoyo', 'chip')
                this._removeAllItems()
              }}
              style={{
  ...
  render() {
    ...
    // work around to make touchables in bottom sheet 
    let TouchableForBottomSheet = useInBottomSheet && Platform.OS === "android" ? TouchableOpacityBottomSheet : Touchable;
    // if(useInBottomSheet && Platform.OS === "android") {
    //   TouchableForBottomSheet = TouchableOpacityBottomSheet;
    // }
